        ...
        <form action="<?= base_url('auth/loginProcess') ?>" method="post" class="space-y-5" id="loginForm">
            ...
            <div>
                ...
                <div class="relative group">
                    ...
                    <button type="button" onclick="togglePass()" class="absolute inset-y-0 right-0 pr-4 flex items-center text-slate-400 hover:text-indigo-500 transition-colors focus:outline-none">
